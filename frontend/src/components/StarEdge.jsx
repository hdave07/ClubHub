 ...
 * over it, in the same outcome color (see edgeLook in StarGraph) (pathLength=1 and a dash offset) when the edge is part of the hovered constellation, so the line grows
 ...
 *   data: { base: string, baseWidth: number, lit: string, litWidth: number, instant: boolean } }} props
 */
